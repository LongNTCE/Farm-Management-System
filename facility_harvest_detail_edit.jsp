                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 offset-lg-2 col-lg-8">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <h3 class="mt-1 mb-3 pb-1 text-center">${edit_record_harvest_text}</h3>
                                    ...
                                    <form action="EditHarvestRecord" method="post">
                                        ...
                                        <div class="row form-outline mb-2">
                                            ...
                                            <select class="col-7" name="harvestRpond"  class="form-select" aria-label="Default select example">
