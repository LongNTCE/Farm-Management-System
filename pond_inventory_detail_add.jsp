                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 offset-lg-2 col-lg-8">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <h3 class="mt-1 mb-3 pb-1 text-center">${add_record_pond_inventory_text}</h3>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="row form-outline mb-2">
                                            ...
                                            <select  class="col-7" class="form-select" name="faInventoryID" aria-label="Default select example">
                                        ...
                                        <div class="text-center pt-1 mb-5">
                                            <button href="PondInventory_Detail?pondInventoryTID=${pondInventoryTIDss}" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-6 py-2 px-5" type="submit">${add_report_detail_btn_text}</button>
                                        </div>
