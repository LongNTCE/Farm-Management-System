...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="mt-3">
                <div class="mt-5">
                    <a href="pondDetail" class="text-decoration-none mt-5"> <h6><i class="fa fa-arrow-left ms-auto mt-4" aria-hidden="true"></i>Back to previous page</h6> 
                    </a>
                </div>
                <h2>${report_manage_pond_inventory_report_text}</h2>
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button
                                        ...
                                        aria-selected="true"
                                        >
                                        ${report_pond_inventory_report_list_text}
                                    </button>

                                    <!-- Button trigger modal -->
                                    <!--Nav Link-->
                                    <a
                                        href="addPInventoryTable"
                                                                                                ...
                                                                                                <div class="row no-gutters">
                                                                                                    ...
                                                                                                    <div class="col-md-8">
                                                                                                        <div class="card-body">
                                                                                                            ...
                                                                                                            <h4 class="card-title" style="height: 55px; overflow: auto">${pi.pondInventoryTName}</h4>
                                            ...
                                            <div  class="col-md-4 col-lg-4 mt-3 clickable list-item" >
                                                <div class="two">
                                                    ...
                                                    <div class="pt-0">
                                                        ...
                                                        <h4 class="card-title" style="height: 55px; max-height: 65px; overflow: auto; word-break: break-all;">${pi.pondInventoryTName}</h4>
                                                    ...
                                                    <div class="d-flex justify-content-center px-3 align-items-center">
                                                        ...
                                                        <div class="col-3 list-card-btn pb-3">
                                                            ...
                                                            <form action="pondInventory_Management" method ="post" id="myform_deleteall${pi.pondInventoryTID}">
                                                                <input hidden disable value="${pi.pondInventoryTID}" name="ccc"/>
                                                                <button
                                                                    href="pondInventory_Management"
                                                                    type="button nav-link"
                                                            ...
                                                            <!-- Button trigger modal -->
                                                            <button class="col-12 btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2${pi.pondInventoryTID}">
                                                                ${report_delete_report_text}
                                                            </button>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModal2${pi.pondInventoryTID}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input class="btn btn-danger" type="submit" form="myform_deleteall${pi.pondInventoryTID}" value="${report_delete_report_text}"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
