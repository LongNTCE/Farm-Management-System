...
mysqli_select_db($conn,"u188051294_grad_project");
	...
	$stmt = mysqli_prepare($conn, "SELECT pond.pondID,pond.pondCode,pond.pondName,pond.pondSquare FROM pond INNER JOIN `crop - pond` ON pond.pondID = `crop - pond`.pondID WHERE `crop - pond`.cropID =$cropID;");
