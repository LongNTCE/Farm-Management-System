 ...
 * @author Admin
 */
public class PondWaterEnvironment_Record {
    ...
    public PondWaterEnvironment_Record(int pondEnvID, int pondID, Date envDate, double dissolveOxygen_morning, double dissolveOxygen_afternoon, double pH_morning, double pH_afternoon, double temperature_morning, double temperature_afternoon, double salinity, double purity, double NH3, double alkali, double H2S) {
