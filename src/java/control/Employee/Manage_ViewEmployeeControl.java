 ...
 * @author Asus
 */
@WebServlet(name = "Manage_ViewEmployeeControl", urlPatterns = {"/Manage_ViewEmployeeControl"})
public class Manage_ViewEmployeeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Employee> femployeeList = dao.getEmployeefID(facilityID);
        out.println(femployeeList);
        request.setAttribute("listEmployee", femployeeList);
