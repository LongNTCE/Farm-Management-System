    ...
    <body>
        ...
        <div class="container">
            <div class="mt-3">
                ...
                <h2>${report_manage_water_env_report_text}</h2>
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button
                                        ...
                                        aria-selected="true"
                                        >
                                        ${report_water_env_list_text}
                                    </button>

                                    <!-- Button trigger modal -->
                                    <!--Nav Link-->
                                    <a
                                        href="addPondWaterEnvTable"
                            ...
                            <div class="tab-content mt-3" id="nav-tabContent">
                                ...
                                <div
                                    ...
                                    <div class="row list-wrapper">
                                        ...
                                        <c:forEach items="${listPWaterEnvRecordByPID}" var="pw">
                                                                                                ...
                                                                                                <div class="row no-gutters">
                                                                                                    ...
                                                                                                    <div class="col-md-8">
                                                                                                        <div class="card-body">
                                                                                                            ...
                                                                                                            <h4 class="card-title" style="height: 55px; overflow: auto">${pw.pondEnvTName}</h4>
                                            
                                                                                                            <div class="row mt-2 g-0">
                                                                                                                <div class="col-3 ms-1">
                                                                                                                    <a
                                                                                                                        href="pondWaterEnvDetail?pondWaterEnvTID=${pw.pondWaterEnvTID}"
                                                                                                                        type="button nav-link"
                                                                                                                        id="add-farm-button"
                                                                                                                ...
                                                                                                                <div class="col-3 ms-1">
                                                                                                                    <a
                                                                                                                        href="editPondWaterEnvTableButton?pondWaterEnvTID=${pw.pondWaterEnvTID}"
                                                                                                                        type="button nav-link"
                                                                                                                        id="add-farm-button"
                                                                                                                        class="btn btn-primary add-farm-button col-12"
                                                                                                                ...
                                                                                                                <div class="col-3 ms-1">
                                                                                                                    <form action="pondWaterEnv_Management" method ="post">
                                                                                                                        <input hidden disable value="${pw.pondWaterEnvTID}" name="ccc"/>
                                                                                                                        <button
                                                                                                                            href="pondWaterEnv_Management"
                                                                                                                            type="button nav-link"
                                                                                                                            id=""
                                            ...
                                            <div  class="col-md-4 col-lg-4 mt-3 clickable list-item" >
                                                <div class="two">
                                                    ...
                                                    <div class="pt-0">
                                                        ...
                                                        <h4 class="card-title"  style="max-height: 58px; overflow: auto; word-break: break-all;">${pw.pondEnvTName}</h4>
                                                    ...
                                                    <div class="d-flex justify-content-center px-3 align-items-center">
                                                        ...
                                                        <div class="col-3 list-card-btn pb-3">
                                                            ...
                                                            <form action="pondWaterEnv_Management" method ="post" id="myform_deleteall${pw.pondWaterEnvTID}">
                                                                <input hidden disable value="${pw.pondWaterEnvTID}" name="ccc"/>
                                                                <button
                                                                    href="pondWaterEnv_Management"
                                                                    type="button nav-link"
                                                                ...
                                                                <!-- Button trigger modal -->
                                                                <button class="col-12 btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2${pw.pondWaterEnvTID}">
                                                                    ${report_delete_report_text}
                                                                </button>
                                                            </form>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModal2${pw.pondWaterEnvTID}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input class="btn btn-danger" type="submit" form="myform_deleteall${pw.pondWaterEnvTID}" value="${report_delete_report_text}"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <c:forEach items="${listPWaterEnvRecordByPID}" var="pw">
                                            <div  class="col-md-4 col-lg-4 mt-3 clickable list-item" >
                                                <div class="two">
                                                    ...
                                                    <p class="justtify-content-center fw-bold">${report_report_name_text}
                                                    </p>
                                                    <div class="pt-0">
