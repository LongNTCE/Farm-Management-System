                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 offset-lg-3 col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <h3 class="mt-1 mb-3 pb-1 text-center">Sửa chi tiết báo cáo giống cơ sở</h3>
                                    ...
                                    <form action="EditBreedRecord" method="post">
                                        ...
                                        <div class="row form-outline mb-2">
                                            <label class="col-7">Tên ao</label>
                                            <div  class="col-5">
                                                <select name="breedRpond"  class="form-select" aria-label="Default select example">
                                        ...
                                        <div class="row form-outline mb-2">
                                            ...
                                            <input
                                                ...
                                                name="breedRcert"
                                                class="form-control"
                                                placeholder="Số giáy chứng nhận kiểm dich"
                                                />
                                        </div>
