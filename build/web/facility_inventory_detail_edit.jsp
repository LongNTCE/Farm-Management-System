                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 offset-lg-3 col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <h3 class="mt-1 mb-3 pb-1 text-center">Sửa chi tiết báo cáo kho</h3>


                                    <form action="EditFInventoryRecordControl" method="post">
                                        ...
                                        <div class="row form-outline mb-2">
                                            <label class="col-6">Ngày nhập </label>
                                            <input
                                                class="col-6"
                                                type="date"
                                                id=""
                                        ...
                                        <div class="row form-outline mb-2">
                                              <label class="col-6">Tên nguồn </label>
                                            <input
                                                class="col-6"
                                                type="text"
                                                id=""
                                        ...
                                        <div class="row form-outline mb-2">
                                            <label class="col-6">Ngày sản xuất </label>
                                            <input
                                                class="col-6"
                                                type="date"
                                                id=""
                                                required="required"
                                                value="${e.manurfacturingDate}"
                                        ...
                                        <div class=" row form-outline mb-2">
                                              <label class="col-6">Ngày hết hạn </label>
                                            <input
                                                class="col-6"
                                                type="date"
                                                id=""
