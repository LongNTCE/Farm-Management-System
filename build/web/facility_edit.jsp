                            ...
                            <div class="col-12 offset-lg-3 col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    <div class="">
                                        ...
                                        <h3 class="mt-1 mb-3 pb-1 text-center">Chỉnh sửa cơ sở</h3>
                                    </div>
                                    ...
                                    <form action="editFacility" method="post">
                                        <div class="row form-outline mb-2">
                                            ...
                                            <input
                                                ...
                                                class="form-control"
                                                placeholder=""
                                                type="text" name="add_fName" title="Nhập tối đa 20 kí tự bao gồm chữ cái và số." id="" minlenght='1' maxlength="20"
                                                />
                                        </div>
                                        ...
                                        <div class="row form-outline mb-2">
                                            ...
                                            <input
                                                ...
                                                class="form-control"
                                                placeholder=""
                                                title="Nhập tối đa 20 kí tự bao gồm chữ cái và số." minlenght='1' maxlength="20"
                                                />
                                        </div>
