                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 offset-lg-3 col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <h3 class="mt-1 mb-3 pb-1 text-center">Thêm báo cáo kho vào bảng</h3>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="row form-outline mb-2">
                                            <label class="col-6">Tên sản phẩm</label>
                                            <select  class="col-6" class="form-select" name="faInventoryID" aria-label="Default select example">

                                             
                                                <c:forEach items="${listFacilityInventory}" var="pc">
                                        ...
                                        <div class="text-center pt-1 mb-5">
                                            <button href="PondInventory_Detail?pondInventoryTID=${pondInventoryTIDss}" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-6 py-2 px-5" type="submit">Thêm báo cáo</button>
                                        </div>
