                            ...
                            <div class="col-12 col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h6 class="text-primary mt-3">Đăng kí cho chủ cơ sở</h6>
                                    </div>

                                    <form action="signup" method="post">
                                        <p>Chọn vai trò đi thằng lồn</p>
                                        <select class="form-select form-select-sm mb-2"  name="signup_role" aria-label=".form-select-sm example">
                                            <option  value="signup_type_fowner">Chủ cơ sở</option>
                                            <option  value="signup_type_employee">Nhân Công</option>

                                        </select>

                                        <div class="form-outline mb-2">
                                            <input type="text" name="signup_username" value="${signup_user}" id="" class="form-control"  required="required" title="Nhập 6 đến 20 kí tự bao gồm chữ cái và số." placeholder="Tên đầy đủ"/><p class="text-danger"> ${error1}</p>
                                        ...
                                        <div class="form-outline mb-2">
                                            <input type="text" pattern="[0][0-9]{9}" name="signup_phoneNum" value="${signup_phoneNum}" id="" required="required" class="form-control" title="Số điện thoại không hợp lệ." placeholder="Số điện thoại"/>
                                        ...
                                        <div class="form-outline mb-2">
                                            <input type="password" name="signup_pass" value="${signup_pass}" onmouseover="mouseoverPass();" onmouseout="mouseoutPass();" id="pass1" class="form-control" placeholder="Mật khẩu" required="required" />

                                        </div>

                                        <div class="form-outline mb-2">
                                            <input type="password" name="signup_repass" value="${signup_repass}" onmouseover="mouseoverPass2();" onmouseout="mouseoutPass2();" id="pass2" class="form-control" placeholder="Nhập lại mật khẩu" required="required" /><p class="text-danger"> ${error5}</p>
