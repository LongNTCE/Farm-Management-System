                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-12 offset-lg-3 col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <h3 class="mt-1 mb-3 pb-1 text-center">Thêm bản báo cáo thu hoạch</h3>
                                    ...
                                    <form action="AddFacilityHarvestRecord" method="post">
                                        ...
                                        <div class="row form-outline mb-2">        
                                            ...
                                            <select  class="col-5" class="form-select" aria-label="Default select example" name="harvestRpond">
