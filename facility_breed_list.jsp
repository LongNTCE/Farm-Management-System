    ...
    <body>
        ...
        <div class="container">
            <div class="mt-5">
                ...
                <h2>${report_manage_breed_report_text}</h2>
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <button
                                        ...
                                        aria-selected="true"
                                        >
                                        ${report_breed_report_list_text}
                                    </button>

                                    <!-- Button trigger modal -->
                                    <!--Nav Link-->
                                    <a
                                        href="AddFacilityBreedTable"
                                ...
                                <div
                                    ...
                                    <div class="row list-wrapper">
                                                                                                ...
                                                                                                <div class="row no-gutters">
                                                                                                    ...
                                                                                                    <div class="col-md-8">
                                                                                                        <div class="card-body">
                                                                                                            ...
                                                                                                            <h4 class="card-title " style="height: 55px; overflow: auto">${br.fBreedTName}</h4>
                                        ...
                                        <c:forEach items="${listBreedRecordByCID}" var="br">
                                            <div  class="col-md-4 col-lg-4 mt-3 clickable list-item" >
                                                <div class="two">
                                                    ...
                                                    <div class="pt-0">
                                                        ...
                                                        <h4 class="card-title"  style="height: 55px; max-height: 65px; overflow: auto; word-break: break-all;">${br.fBreedTName}</h4>
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        ...
                                                        <div class="col-3 list-card-btn pb-3">
                                                            ...
                                                            <form action="facilityBreed_Management" method ="post"  id="myform_deleteall${br.fBreedTID}">
                                                                <input hidden disable value="${br.fBreedTID}" name="ccc"/>
                                                                <button
                                                                    href="facilityBreed_Management"
                                                                    type="button nav-link"
                                                                ...
                                                                <!-- Button trigger modal -->
                                                                <button class="col-12 btn btn-danger" type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal2${br.fBreedTID}">
                                                                    ${report_delete_report_text}
                                                                </button>
                                                            </form>
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModal2${br.fBreedTID}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input class="btn btn-danger" type="submit" form="myform_deleteall${br.fBreedTID}" value="${report_delete_report_text}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
