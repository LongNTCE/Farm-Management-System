    ...
    <body>
        ...
        <div class="container">
            <div class="mt-3">
                ...
                <h2>${report_manage_facility_inventory_report_text}</h2>
                <div class="row">
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button
                                        ...
                                        aria-selected="true"
                                        >
                                        ${report_inventory_report_list_text}
                                    </button>
                                    <!-- Button trigger modal -->
                                    <!--Nav Link-->
                                    <a
                                        href="AddFInventoryTableControl"
                            ...
                            <div class="tab-content mt-3" id="nav-tabContent">
                                ...
                                <div
                                    ...
                                    <div class="row list-wrapper">
                                        ...
                                        <c:forEach items="${listInventoryRecordByCID}" var="ir">
                                                                                                ...
                                                                                                <div class="row no-gutters">
                                                                                                    ...
                                                                                                    <div class="col-md-8">
                                                                                                        <div class="card-body">
                                                                                                            ...
                                                                                                            <h4 class="card-title" style="height: 55px; overflow: auto">${ir.fInventoryTName}</h4>
                                                                                                            <div class="row mt-2 g-0">
                                                                                                                <div class="col-3 ms-1">
                                                                                                                    <a
                                                                                                                        href="facilityInventoryDetail?fInventoryTID=${ir.fInventoryTID}"
                                                                                                                        type="button nav-link"
                                                                                                                        id="add-farm-button"
                                                                                                                ...
                                                                                                                <div class="col-3 ms-1">
                                                                                                                    <a
                                                                                                                        href="EditFacilityInventoryTableButton?fInventoryTID=${ir.fInventoryTID}"
                                                                                                                        type="button nav-link"
                                                                                                                        id="add-farm-button"
                                                                                                                        class="btn btn-primary add-farm-button col-12"
                                                                                                                ...
                                                                                                                <div class="col-3 ms-1">
                                                                                                                    <form action="facilityInventory_Management" method ="post">
                                                                                                                        <input hidden disable value="${ir.fInventoryTID}" name="ccc"/>
                                                                                                                        <button
                                                                                                                            href="facilityInventory_Management"
                                            ...
                                            <div  class="col-md-4 col-lg-4 mt-3 clickable list-item" >
                                                <div class="two">
                                                    ...
                                                    <div class="pt-0">
                                                        ...
                                                        <h4 class="card-title" style="height: 55px; max-height: 65px; overflow: auto; word-break: break-all;">${ir.fInventoryTName}</h4>
                                                    ...
                                                    <div class="d-flex justify-content-center px-3 align-items-center">
                                                        ...
                                                        <div class="col-3 list-card-btn pb-3">
                                                            ...
                                                            <form action="facilityInventory_Management" method ="post" id="myform_deleteall${ir.fInventoryTID}">
                                                                <input hidden disable value="${ir.fInventoryTID}" name="ccc"/>
                                                                <button
                                                                    href="facilityInventory_Management"
                                                                ...
                                                                <!-- Button trigger modal -->
                                                                <button class="col-12 btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2${ir.fInventoryTID}">
                                                                    ${report_delete_report_text}
                                                                </button>
                                                            </form>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModal2${ir.fInventoryTID}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input class="btn btn-danger" type="submit" form="myform_deleteall${ir.fInventoryTID}" value="${report_delete_report_text}"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
